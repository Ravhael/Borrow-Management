...
import { HeroHeaderProps } from '../../types/dashboard'
import { loginTheme } from '../../themes/loginTheme'
import StatCardsRow from '../shared/StatCardsRow'
import buildGudangStatCards from '../shared/gudangStatCards' 

export default function HeroHeader({ stats, title = "Selamat Datang" }: HeroHeaderProps) {
  // use Gudang statcards definition for consistency across dashboards
  const statCards = buildGudangStatCards(stats) 
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 4 }}>
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              ...
              <Box>
                ...
                >
                  Comprehensive overview of your loan management system. Monitor requests, track approvals, and manage operations efficiently.
                </Typography>
              </Box>
            </Box>
