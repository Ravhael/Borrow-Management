...
import { MarketingHeroHeaderProps } from '../../types/marketingDashboard';
import { loginTheme } from '../../themes/loginTheme'
import StatCardsRow from '../shared/StatCardsRow';
import buildGudangStatCards from '../shared/gudangStatCards' 

const MarketingHeroHeader: React.FC<MarketingHeroHeaderProps> = ({ currentUser, stats }) => {
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 4 }}>
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              ...
              <Box>
                ...
                >
                  Halo, {currentUser?.name || 'Marketing'}
                </Typography>
                <Typography
                  variant="h5"
                  sx={{
...
export default MarketingHeroHeader;